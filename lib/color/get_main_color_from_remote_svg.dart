...
import 'package:xapptor_logic/image/get_remote_svg.dart';
...
Future<Color> get_main_color_from_remote_svg(String url) async {
  ...
  String svg_string_color = "0xff${svg_string.substring(
    svg_string_color_index + 1,
    svg_string_color_index + 7,
  )}";
